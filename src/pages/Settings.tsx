            ...
            <div className="container">
                ...
                <div className="card settings-card">
                    ...
                    <div className="license-info">
                        ...
                        <p>This app uses anatomical SVG graphics provided by flutter_body_atlas.</p>
                        <p><strong>License:</strong> CC BY 4.0</p>
                        <p><a href="https://creativecommons.org/licenses/by/4.0/" target="_blank" rel="noreferrer">License Link</a></p>
                ...
                {/* 앱 정보 섹션 */}
                <div style={{ textAlign: 'center', marginTop: '3rem', fontSize: '0.8rem', color: 'var(--text-secondary)' }}>
